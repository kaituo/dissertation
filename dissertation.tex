...
\begin{enumerate}
  \item x $\leq$ t: Variable type x is a subtype of constant type x. 
  \item x $\leq$ y: Variable type x is a subtype of variable type y.
  \item t $\leq$ x: Constant type t is a subtype of variable type x.
  \item x $=$ y: Variable type x equals to variable type y.
  \item x $=$ t: Variable type x equals to constant type t.
\end{enumerate}
